...
//it is important to Remember that actions only describe what happened, 
...
export const createReducer = (initialState = {}, actionHandlerKeyFuncs = {}) => {
  ...
  // It needs to be noted that passing the asyncRequestFn without params is not ideal, but 
